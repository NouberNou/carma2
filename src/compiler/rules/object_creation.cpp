...
compiler::context::type new_keyword_rule::type = compiler::context::type::OBJECT;
compiler::context::type del_keyword_rule::type = compiler::context::type::OBJECT;
compiler::context::type anon_object_rule::type = compiler::context::type::OBJECT;

bool carma::rules::new_keyword_rule::match(carma::compiler::context& a_scope, token_list &tokens_, token_entry& start_entry_, token_entry& end_entry_) {
    return start_entry_->val == "new";
}

void carma::rules::new_keyword_rule::apply(carma::compiler::context& a_scope, token_list &tokens_, token_entry& start_entry_, token_entry& end_entry_) {
...
bool carma::rules::del_keyword_rule::match(carma::compiler::context& a_scope, token_list &tokens_, token_entry& start_entry_, token_entry& end_entry_) {
    return start_entry_->val == "del";
}

void carma::rules::del_keyword_rule::apply(carma::compiler::context& a_scope, token_list &tokens_, token_entry& start_entry_, token_entry& end_entry_) {
...
bool carma::rules::anon_object_rule::match(carma::compiler::context& a_scope, token_list &tokens_, token_entry& start_entry_, token_entry& end_entry_) {
    return start_entry_->val == "{";
}

void carma::rules::anon_object_rule::apply(carma::compiler::context& a_scope, token_list &tokens_, token_entry& start_entry_, token_entry& end_entry_) {
    ...
    for (current_token; current_token != end_entry_ && current_token->val != "}" && current_token->val != ";"; current_token++) {
